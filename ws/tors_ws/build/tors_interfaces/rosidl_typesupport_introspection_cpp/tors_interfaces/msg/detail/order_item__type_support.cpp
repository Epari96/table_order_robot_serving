...
{
  new (message_memory) tors_interfaces::msg::OrderItem(_init);
}

void OrderItem_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tors_interfaces::msg::OrderItem *>(message_memory);
  typed_message->~OrderItem();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember OrderItem_message_member_array[2] = {
  {
    "name",  // name
    ...
    offsetof(tors_interfaces::msg::OrderItem, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tors_interfaces::msg::OrderItem, quantity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OrderItem_message_members = {
  "tors_interfaces::msg",  // message namespace
  "OrderItem",  // message name
  2,  // number of fields
  sizeof(tors_interfaces::msg::OrderItem),
...
{
  return &::tors_interfaces::msg::rosidl_typesupport_introspection_cpp::OrderItem_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tors_interfaces, msg, OrderItem)() {
  return &::tors_interfaces::msg::rosidl_typesupport_introspection_cpp::OrderItem_message_type_support_handle;
}
