...
bool tors_interfaces__msg__order_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tors_interfaces.msg._order_item.OrderItem", full_classname_dest, 41) == 0);
  }
  tors_interfaces__msg__OrderItem * ros_message = _ros_message;
  {  // name
...
PyObject * tors_interfaces__msg__order_item__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tors_interfaces.msg._order_item");
